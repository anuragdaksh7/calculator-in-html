...
export default function Home() {
  ...
  return (
    <>
      <h1 className='text-white text-3xl text-center mt-6 font-bold'>Calculator Using React</h1>
      <div className="mt-8 flex justify-center w-full">
        <form className="w-full sm:w-1/2 lg:w-1/4 p-6 rounded-lg bg-[#FFFFFF]/[0.10]">
